...
class Base(InfoCrud):
    ...
    @classmethod
    def get_paginate_models_with_img(cls, start, count, q=None):
    ...
    @classmethod
    def get_models_by_ids_with_img(cls, ids):
    ...
    @classmethod
    def new_model(cls, data, *, err_msg):
    ...
    @classmethod
    def edit_model(cls, id, data, *, err_msg):
        model = cls.query.filter_by(id=id, delete_time=None).first()
        if model is None:
    ...
    @classmethod
    def remove_model(cls, id, *, err_msg):
        model = cls.query.filter_by(id=id, delete_time=None).first()
        if model is None:
            raise NotFound(msg=err_msg)
